...
struct TagIncomingLeadView: View {
    ...
    var body: some View {
        ...
        let isInterestedSegmentView = CustomSegmentedPickerView(viewModel: viewModel, tagOptions: [.lowInterest, .fair, .lead])
...
struct TagIncomingLeadView_Previews: PreviewProvider {
    static var previews: some View {
        TagIncomingLeadView(viewModel: TagIncomingLeadViewModel(
                                addressableDataFetcher: AddressableDataFetcher()), taggingComplete: {}).environmentObject(Application())
    }
}
